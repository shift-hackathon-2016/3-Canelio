    ...
    (function($, undefined) {
        ...
        var HistoryAdapter = kendo.Class.extend({
            back: function () {
                ...
                if (BROKEN_BACK_NAV) {
                    console.log("history_back broken");
                    setTimeout(function() { history.back(); });
                } else {
                    console.log("history_back not broken");
                    history.back();
        ...
        var PushStateAdapter = HistoryAdapter.extend({
            init: function(root) {
                console.log("iiiiiiiiiiiiiiiiiiiinit pushstate");
                this.root = root;
            },
            ...
            change: function (callback) {
                console.log("popstate.back called");
        ...
        var HashAdapter = HistoryAdapter.extend({
            init: function(bang) {
                console.log("iiiiiiiiiiiiiiiiiiiinit hashAdapter");
                this._id = kendo.guid();
            ...
            navigate: function (to) {
                ...
                console.log("------------- navigate called hashAdapter");
                //location.hash = this.fix(to);
                
                console.log(this.fix(to));
                if (to === '#:back') {
                    location.hash = this.fix(to);
                }
                if (to == "#achivementListView "){
                    location.hash = '/achievmentsList?view=achivementList';
                } else {
                    location.hash = '/achievmentsList?view=singleAchivment'
                }
            },
            ...
            change: function (callback) {
                console.log("hashadapter change callled");
        ...
        var History = kendo.Observable.extend({
            ...
            change: function (callback) {
                console.log("history change callled");
                this.bind(CHANGE, callback);
            },

            replace: function(to, silent) {
                console.log("history replace callled");
            ...
            _checkUrl: function () {
                console.log("history _checkUrl callled!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
                var adapter = this.adapter,
                    current = adapter.current(),
    ...
    (function() {
        ...
        var Router = Observable.extend({
            ...
            _urlChanged: function (e) {
                console.log("_url changed called 123");
                var url = e.url;
