App.controller("bleRead", function ($scope, db_Trainig, $q) {
    ...
    var app = {
        ...
        readBatteryState: function (event) {
            ...
            ble.read(deviceId, battery.service, battery.level, app.onReadBatteryLevel, app.onErrorRead);
            setTimeout(function(){
                app.readBatteryState(event);
            }, 1);

        },
        onErrorRead: function(e){
            console.log(e);
            alertify.error("read failled");
        },
